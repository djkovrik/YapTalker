...
import com.sedsoftware.yaptalker.data.service.YapGetPostQuotedTextService
...
abstract class ChosenTopicFragmentModule {
  ...
  @FragmentScope
  @Binds
  abstract fun quoteService(service: YapGetPostQuotedTextService): GetPostQuotedTextService
}
