...
class FabMenuItemPrimary(
    ...
    override fun show() {
        if (showSecondaryView) {
            val hideAnimator =
                AnimatorInflater.loadAnimator(context, R.animator.fab_menu_rotate_button_hide) as AnimatorSet
            ...
            val showAnimator =
                AnimatorInflater.loadAnimator(context, R.animator.fab_menu_rotate_button_show) as AnimatorSet
