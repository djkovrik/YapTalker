...
**Исправлено**
* Изменение кармы поста теперь всегда отображается корректно и без перезагрузки текущей страницы темы
...
**Добавлено**
* Тэги для тем и поиск по клику на тэг

**Изменено**
* Превью-картинка видео вместо иконки воспроизведеня теперь отображает небольшую метку с источником видео (youtube, vk, yap и т.д.)
