...
**Исправлено**
* Логика работы с закладками переведена с веб на апи вызовы для большей стабильности в будущем

### [1.0.11] - 2026-06-01

**Исправлено**
* Ошибки с парсингом инфо о текущей сессии пользователя, из-за которых не работал выход из профиля в приложении
* Ошибки с авторизацией на Android 16+
* Методы связанные с логином, комментариями и кармой переведены с веб на апи вызовы для большей стабильности в будущем

### [1.0.10] - 2026-05-12

**Исправлено**
* Отображение цитат и выставление кармы сообщениям
* Краш и ошибки при загрузке apk у встроенной системы скачивания обновлений программы

### [1.0.9] - 2026-05-10

**Исправлено**
* Парсинг страниц адаптирован под последние изменения дизайна на сайте
* 
### [1.0.8] - 2020-02-11

**Исправлено**
* Постраничная подгрузка сообщений во всех разделах сайта

### [1.0.7] - 2020-02-01

**Исправлено**
* Отображение превью-картинок разделов форума
* Отображение панели смайлов
* Отправка сообщений
